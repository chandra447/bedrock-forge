...
module "customer_support_auto_execution_role" {
  source      = "git::https://github.com/company/bedrock-terraform-modules//modules/iam-role?ref=v1.0.0"
  role_name   = "customer-support-auto-execution-role"
  description = "Auto-generated execution role for Bedrock agent customer-support-auto"
  assume_role_policy = {
    statement = [{
  ...
  tags = {
    Agent     = "customer-support-auto"
    CreatedBy = "bedrock-forge"
    Purpose   = "BedrockAgentExecution"
  }
}

module "customer_support_execution_role" {
  source      = "git::https://github.com/company/bedrock-terraform-modules//modules/iam-role?ref=v1.0.0"
  role_name   = "customer-support-execution-role"
  description = "Auto-generated execution role for Bedrock agent customer-support"
  assume_role_policy = {
    statement = [{
      action = "sts:AssumeRole"
      effect = "Allow"
...
module "custom_agent_execution_role" {
  source      = "git::https://github.com/company/bedrock-terraform-modules//modules/iam-role?ref=v1.0.0"
  role_name   = "custom-agent-execution-role"
  ...
  managed_policies = [{
    policy_arn = "arn:aws:iam::aws:policy/service-role/AmazonBedrockAgentResourcePolicy"
    }, {
  ...
  inline_policies = [{
    ...
    policy = {
      statement = [{
        ...
        effect   = "Allow"
        resource = ["arn:aws:bedrock:*:*:knowledge-base/*", "arn:aws:bedrock:*:*:data-source/*"]
    ...
    policy = {
      statement = [{
        ...
        effect   = "Allow"
        resource = ["arn:aws:s3:::company-kb-documents/*", "arn:aws:s3:::company-kb-documents"]
...
module "customer_support" {
  ...
  agent_resource_role_arn     = "$${module.customer_support_execution_role.role_arn}"
  guardrail = {
...
module "customer_support_auto" {
  ...
  description                 = "Customer support agent for order management"
  idle_session_ttl_in_seconds = 3600
  agent_resource_role_arn     = "$${module.customer_support_auto_execution_role.role_arn}"
  guardrail = {
    guardrail_id      = "$${module.content_safety_guardrail.guardrail_id}"
    guardrail_version = "$${module.content_safety_guardrail.guardrail_version}"
    mode              = "pre"
...
module "customer_support_custom" {
  source                      = "git::https://github.com/company/bedrock-terraform-modules//modules/bedrock-agent?ref=v1.0.0"
  ...
  description                 = "Customer support agent for order management"
  idle_session_ttl_in_seconds = 3600
  agent_resource_role_arn     = "$${module.custom_agent_execution_role.role_arn}"
  guardrail = {
    guardrail_id      = "$${module.content_safety_guardrail.guardrail_id}"
    guardrail_version = "$${module.content_safety_guardrail.guardrail_version}"
    mode              = "pre"
...
module "customer_support_existing" {
  source                      = "git::https://github.com/company/bedrock-terraform-modules//modules/bedrock-agent?ref=v1.0.0"
  ...
  description                 = "Customer support agent for order management"
  idle_session_ttl_in_seconds = 3600
  agent_resource_role_arn     = "arn:aws:iam::123456789012:role/ExistingBedrockAgentRole"
  guardrail = {
    guardrail_id      = "$${module.content_safety_guardrail.guardrail_id}"
    guardrail_version = "$${module.content_safety_guardrail.guardrail_version}"
    mode              = "pre"
...
output "customer_support_auto_agent_id" {
  description = "ID of the customer-support-auto agent"
  value       = module.customer_support_auto.agent_id
}
output "customer_support_auto_agent_arn" {
  description = "ARN of the customer-support-auto agent"
  value       = module.customer_support_auto.agent_arn
}
output "customer_support_custom_agent_id" {
  description = "ID of the customer-support-custom agent"
  value       = module.customer_support_custom.agent_id
}
output "customer_support_custom_agent_arn" {
  description = "ARN of the customer-support-custom agent"
  value       = module.customer_support_custom.agent_arn
}
output "customer_support_existing_agent_id" {
  description = "ID of the customer-support-existing agent"
  value       = module.customer_support_existing.agent_id
}
output "customer_support_existing_agent_arn" {
  description = "ARN of the customer-support-existing agent"
  value       = module.customer_support_existing.agent_arn
}
