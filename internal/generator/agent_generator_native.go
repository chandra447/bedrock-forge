...
// convertFunctionSchemaToOpenAPI converts function schema to OpenAPI format
func (g *HCLGenerator) convertFunctionSchemaToOpenAPI(schema *models.FunctionSchema) string {
	...
	for _, fn := range schema.Functions {
		...
		schemaName := fmt.Sprintf("%sRequest", fn.Name)
	...
	jsonBytes, _ := json.Marshal(openAPI)
